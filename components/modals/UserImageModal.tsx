...
const UserImageModal = ({ setShowUserImage, UserImage, md }: any) => {
  return (
    <div className="fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 h-[85vh] w-[75vw] bg-[#000000] z-20 border-[#343434] border-4 rounded-lg">
      <button
